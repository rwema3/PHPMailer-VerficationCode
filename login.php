...
<body>
    ...
    <main class="d-flex justify-content-center align-items-center" style="height: 90vh;">
        <div class="border pt-5 px-4 shadow-sm pb-8">
            <div class="position-relative text-center">
                ...
                <h6 class="fw-bold">Have an Account? Login</h6>
                <hr>
            ...
            <form method="post">
                ...
                <div class="row mt-2">
                    <div class="col">
                        <input type="submit" class="w-100 btn btn-info text-white fw-bold rounded-pill" value="Login" name="Login">
                    </div>
                </div>
    ...
    <footer class="d-flex bg-info text-white p-2 justify-content-between fixed-bottom">
        ...
        <div>
            <a href="#" class="text-white px-2" style="text-decoration: none;">Rwema</a>
        </div>
        <div>
